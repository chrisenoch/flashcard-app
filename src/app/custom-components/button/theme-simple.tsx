...
export class Theme {
  ...
  getCSSClassesStringByHTMLLevel(
    ...
    const cssClassesStringByHTMLLevel: CSSClassesStringsByHTMLLevel = {};
    Object.keys(cssClassesSetsByHTMLLevel).forEach((HTMLLevel) => {
      ...
      cssClassesStringByHTMLLevel[HTMLLevel] =
        this.setToSpacedString(finalCSSClassesSet);
    });
    return cssClassesStringByHTMLLevel;
  }
...
type CSSChanges = { add: string | string[]; remove: string | string[] };
type CSSChangesByHTMLLevel = {
  [key: string]: { add: string | string[]; remove: string | string[] };
};
type Component = {
  [key: string]: {
    //light
